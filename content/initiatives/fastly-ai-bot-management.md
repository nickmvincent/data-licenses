---
title: Fastly AI Bot Management
summary: Edge bot-management layer for detecting and blocking AI crawlers and fetchers that scrape website content.
status: live
website: 'https://www.fastly.com/products/fastly-ai-bot-management'
actionsSupported:
  - technical-blocking
...
evidenceLinks:
  ...
  - label: AI Bot Management launch announced
    ...
    date: '2025-04-15'
considerations: Fastly's offer is an enforcement and traffic-management layer, not a licensing market or rights-expression standard on its own.
visibility: public
